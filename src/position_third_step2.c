                             ...
                             double vMax, double vMin, double aMax, double aMin, double jMax)
{
...

    {
        ...
        const double h1 = sqrt(4 * h1a * h1a - 18 * h0 * h0 * h0) * fabs(jMax) / jMax;
...

    {
        ...
        const double h1 = sqrt(4 * h1a * h1a - 6 * h0 * (a0_p4 + af_p4 - 4 * a0_p3 * af + 6 * a0_a0 * af_af + 12 * jMax_jMax * (vd_vd - 2 * af * (pd - tf * v0)) - 4 * a0 * h0b)) * fabs(jMax) / jMax;
    ...
    /* Solution 3 */
    {
        const double h0 = sqrt(3 * (a0_p4 + af_p4 - 4 * af_p3 * jMax * tf + 6 * af_af * jMax_jMax * tf_tf - 4 * a0_p3 * (af - jMax * tf) + 6 * a0_a0 * (af - jMax * tf) * (af - jMax * tf) + 24 * af * jMax_jMax * (-pd + tf * v0) - 4 * a0 * (af_p3 - 3 * af_af * jMax * tf + 6 * jMax_jMax * (-pd + tf * vf)) - 12 * jMax_jMax * (-vd_vd + jMax * tf * (-2 * pd + tf * (v0 + vf))))) * fabs(jMax) / jMax;
        const double h1 = sqrt(3 * (3 * a0_a0 + 3 * af_af - 6 * a0 * af - 6 * ad * jMax * tf + 3 * jMax_jMax * tf_tf - 2 * h0)) * fabs(jMax) / jMax;
    ...
    /* Solution 2 */
    {
        ...
        const double h1 = sqrt(h1a * h1a - h0 * (a0_p4 - 4 * a0_p3 * af + 6 * a0_a0 * af_af + af_p4 + 24 * af * jMax_jMax * (-pd + tf * v0) + 12 * jMax_jMax * vd_vd - 4 * a0 * (af_p3 - 3 * af * jMax_jMax * tf_tf + 6 * jMax_jMax * (-pd + tf * vf)))) * fabs(jMax) / jMax;
    ...
    /* Solution 1 */
    {
        const double h0 = sqrt((a0_p4 + af_p4 - 4 * af_p3 * jMax * tf + 6 * af_af * jMax_jMax * tf_tf - 4 * a0_p3 * (af - jMax * tf) + 6 * a0_a0 * (af - jMax * tf) * (af - jMax * tf) + 24 * af * jMax_jMax * (-pd + tf * v0) - 4 * a0 * (af_p3 - 3 * af_af * jMax * tf + 6 * jMax_jMax * (-pd + tf * vf)) - 12 * jMax_jMax * (-vd_vd + jMax * tf * (-2 * pd + tf * (v0 + vf)))) / 3) * fabs(jMax) / jMax;
        const double h1 = sqrt(ad_ad - 2 * ad * jMax * tf + jMax_jMax * tf_tf + 2 * h0) * fabs(jMax) / jMax;
